...
export default function InputSingleFile({
  ...
  function isValidSize() {
    return fileSize <= maxFileSizeInMb * 1024 * 1024; // 50 * 1024 -> kilobytes; * 1024 -> bytes
  }
    ...
    <div>
      {!formFile || !isValideFile() ? (
        ...
        <>
          {replaceBy}
          <div
            className={`flex gap-3 items-center border border-solid border-border-primary mt-5 p-3 rounded`}
          >
